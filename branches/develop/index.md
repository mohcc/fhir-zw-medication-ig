# Home - Zimbabwe Medication IG v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://mohcc.gov.zw/fhir/medication/ImplementationGuide/zw.fhir.ig.medication | *Version*:0.1.0 |
| Draft as of 2026-06-16 | *Computable Name*:ZWMedication |
...
* Creating an issue on GitHub [medication repository](https://github.com/WorldHealthOrganization/medication)
...
This is an R4 IG. None of the features it uses are changed in R4B, so it can be used as is with R4B systems. Packages for both [R4 (zw.fhir.ig.medication.r4)](package.r4.tgz) and [R4B (zw.fhir.ig.medication.r4b)](package.r4b.tgz) are available.
...
* [AllergyIntolerance Clinical Status Codes](http://terminology.hl7.org/7.2.0/CodeSystem-allergyintolerance-clinical.html): [AllergyIntolerance/allergyintolerance1](AllergyIntolerance-allergyintolerance1.md)
* [AllergyIntolerance Verification Status](http://terminology.hl7.org/7.2.0/CodeSystem-allergyintolerance-verification.html): [AllergyIntolerance/allergyintolerance1](AllergyIntolerance-allergyintolerance1.md)
...
```json
{
  ...
  "id" : "zw.fhir.ig.medication",
  "url" : "http://mohcc.gov.zw/fhir/medication/ImplementationGuide/zw.fhir.ig.medication",
  "version" : "0.1.0",
  "name" : "ZWMedication",
  "title" : "Zimbabwe Medication IG",
  "status" : "draft",
  "experimental" : false,
  "date" : "2026-06-16T07:37:05+00:00",
  ...
  "description" : "Zimbabwe Medication FHIR Implementation Guide covering allergies, medication requests and administration",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "zw.fhir.ig.medication",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://mohcc.gov.zw/fhir/medication/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/medication/StructureDefinition/zw-allergy-intolerance"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "http://mohcc.gov.zw/fhir/medication/StructureDefinition/zw-medication-request"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
